...
object FileUtils {
    fun readJSONDataFromFile(context: Context, sampleData: Boolean): String {
        ...
        try {
            ...
            inputStream = if (sampleData)
                context.assets.open("hospitaldb.json")
            else {
                Log.d(FileUtilsTag, path)
